...
@section('title', 'Input Point Transaction')
        ...
        <div class="row align-items-center">
          <div class="col" style="height: 550px; padding: 20px">
            <div class="col d-flex justify-content-between align-items-center">
                <h5 style="color: white">Input Point</h5>
            </div>
                    ...
                    <div class="col" style="height: 450px;">
                        <div class="mt-2 w-50">
                            ...
                            <form action="data-master-add" method="POST">
                                ...
                                <div class="col-12" style="margin-top: 15px">
                                    <label for="total-purchase" class="form-label">Total Purchase</label>
                                    <input type="number" name="total-purchase" class="form-control" id="total-purchase" placeholder="Total Purchase" style="border-color: #1B6E43; border-width:2px;">
                                </div>
                                <div class="col-12" style="margin-top: 15px">
                                    <label for="input-point" class="form-label">Input Point</label>
                                    <input type="number" name="input-point" class="form-control" id="input-point" placeholder="Input Point" style="border-color: #1B6E43; border-width:2px;">
                                </div>
